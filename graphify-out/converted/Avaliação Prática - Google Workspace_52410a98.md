<!-- converted from Avaliação Prática - Google Workspace.docx -->

AVALIAÇÃO PRÁTICA SIMPLES
Missão: organizar e proteger o computador do setor
# Divisão de responsabilidades
Cada integrante terá um foco principal, mas ambos devem revisar, conhecer e saber explicar todas as entregas.
# Situação-problema
O computador de um pequeno setor da empresa está desorganizado. Os arquivos estão espalhados, não existe rotina de backup, alguns funcionários recebem mensagens suspeitas e ninguém sabe explicar com clareza quais equipamentos e programas são utilizados. A equipe foi escolhida para preparar uma solução simples e orientar o setor.
...
# Entrega 1 — Guia rápido para a equipe
Criem um documento de 1 a 2 páginas no editor de textos com o título “Como organizar e proteger o computador do setor”. O guia deve conter:
...
Nome obrigatório do arquivo: GUIA_DA_EQUIPE (Google Docs)
# Entrega 2 — Inventário básico
Criem uma planilha com pelo menos 6 itens do setor. Usem as colunas abaixo:
Use a linha 1 para os cabeçalhos e as linhas 2 a 7 para os seis primeiros registros. Em G2, escreva TOTAL DE ITENS. Em H2, insira uma fórmula que some as quantidades da coluna D. Aplique filtro na linha 1 e destaque os cabeçalhos com uma cor de fundo.
Nome obrigatório do arquivo: INVENTARIO_DA_EQUIPE (Google Sheets)
# Entrega 3 — Apresentação-relâmpago
Criem uma apresentação com exatamente 4 slides:
...
Usem pouco texto, letras legíveis e pelo menos uma imagem ou ícone adequado. Os dois integrantes devem participar da apresentação.
Nome obrigatório do arquivo: APRESENTACAO_DA_EQUIPE (Google Slides)

# Anexo I — Mensagem técnica
## O que explicar no guia
...
A nota é composta por 7,0 pontos de verificação automática e 3,0 pontos de avaliação do docente. A correção automática confirma requisitos objetivos; a qualidade e a correção das explicações continuam sob responsabilidade do professor.
Observação do docente: __________________________________________________________________________________
Nota: ______ / 10,0     Assinatura da equipe: _____________________________________________
...
| Estudante 2 | ___dtxtxt_____________________________________________________________ |
| Data / Turma | Data: ____/____/________    Turma: ______________________________ |
| Integrante | Nome | Foco principal | Responsabilidade |
| --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- |
| EQ-01 | Monitor | Hardware | 2 | Bom | Limpar |
| “Para reduzir o risco de perda de dados, o setor deve realizar backup semanal dos arquivos em local seguro. Os computadores precisam manter o antimalware atualizado e as contas devem utilizar autenticação com senha forte. Mensagens com links desconhecidos não devem ser abertas sem verificação.” |
| --- |
| Critério | Evidência esperada | Valor |
| --- | --- | --- |
