...
## Corpus Check
- 6 files · ~59,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 105 nodes · 120 edges · 12 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68537a5c`
...
3. `Responsividade` - 10 edges
4. `Módulo 2 — COMPRAS` - 8 edges
5. `Módulo 4 — VENDAS E LOGÍSTICA` - 8 edges
...
Cohesion: 0.15
Nodes (12): 5.1 Usuários, Backend / Banco de Dados, ERP Victor Anato — Orientações de Desenvolvimento, Estrutura de arquivos HTML (uma por tela/módulo), Frontend — Vanilla JS (obrigatório), Módulo 5 — CONFIGURAÇÕES, Ordem de Implementação Sugerida, Padrões JavaScript obrigatórios (+4 more)
