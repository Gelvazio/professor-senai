...
Ao final da unidade curricular, os alunos serão capazes de:

1. **Compreender** os fundamentos de operações matemáticas aplicadas à gestão
2. **Aplicar** conceitos de estatística básica em análise de dados
3. **Utilizar** planilhas eletrônicas com recursos avançados
4. **Criar** dashboards para visualização de dados gerenciais
5. **Resolver** problemas de gestão através da análise de dados
...
- **Aulas expositivas:** Apresentação de conceitos com exemplos práticos
- **Laboratório:** Exercícios práticos em computadores
- **Estudos de caso:** Análise de situações reais
- **Trabalhos em grupo:** Desenvolvimento colaborativo
- **Discussões facilitadas:** Reflexão sobre aplicações práticas
...
### Ambientes
- Sala de aula com projetor e computador
- Laboratório de informática com 20+ computadores
- Biblioteca para consulta de materiais
...
- Dados reais de empresas parceiras
...
1. SENAI. Departamento Nacional. **Raciocínio lógico e análise de dados**. 2. ed. Brasília: SENAI/DN, 2020. E-book. Disponível em: https://meusenai.senai.br/estante/

2. SENAI. Departamento Nacional. **Planilha eletrônica**. Brasília: SENAI/DN, 2012. 68 p. Disponível em: https://meusenai.senai.br/estante/
...
- As aulas devem ser práticas e interativas
- Utilizar dados reais sempre que possível
- Estimular a resolução de problemas autênticos
- Proporcionar feedback contínuo aos alunos
- Adaptar o plano conforme necessário
- Disponibilizar materiais de apoio digitalmente
