# Graph Report - INTRODUCAO_A_TECNOLOGIA_DA_INFORMACAO_E_COMUNICACAO  (2026-08-21)

## Corpus Check
- 41 files · ~157,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 217 nodes · 177 edges · 43 communities (37 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36b79f0b`
...
2. `Unidade Curricular 1: Introdução à Tecnologia da Informação e Comunicação` - 10 edges
3. `Conhecimentos` - 10 edges
4. `Conhecimentos` - 10 edges
5. `Arquivos` - 9 edges
6. `Pesquisa — Planilha Excel de Controle de Abate de Suínos` - 9 edges
7. `ATIVIDADE PRÁTICA — Planilha Eletrônica` - 8 edges
8. `PARTE 2 — Aluno B (Planilha)` - 7 edges
9. `Conhecimentos` - 7 edges
10. `SENAI — Projeto de Curso: Aprendizagem Industrial` - 6 edges
...
Cohesion: 0.10
Nodes (19): Ambientes Pedagógicos e Recursos, Capacidades Básicas, Capacidades Socioemocionais, Carga Horária, ✅ Commit e Push obrigatórios — SEMPRE AO FINAL DE CADA RESPOSTA, Configuração Supabase, Controle de perfil (frontend), Eixo Estruturante BNCC / Competência Integradora (+11 more)
...
Cohesion: 0.29
Nodes (6): Ambientes Pedagógicos e Recursos, Capacidades Básicas, Capacidades Socioemocionais, Conteúdos Formativos, Eixo Estruturante BNCC / Competência Integradora, MÓDULO EDUCAÇÃO PARA O TRABALHO
...
## Knowledge Gaps
- **147 isolated node(s):** `UC: Introdução à Tecnologia da Informação e Comunicação`, `Contexto`, `Divisão da Dupla`, `O que fazer`, `O que criar` (+142 more)
...
- **Why does `SENAI — Projeto de Curso: Aprendizagem Industrial` connect `Community 0` to `Community 9`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Unidade Curricular 1: Introdução à Tecnologia da Informação e Comunicação` connect `Community 0` to `Community 5`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Conhecimentos` connect `Community 5` to `Community 0`?**
